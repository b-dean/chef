...
EOM
      ...
      it "should run recipes specified directly on the command line", :focus do
        file 'config/client.rb', <<EOM
local_mode true
client_key #{path_to('mykey.pem').inspect}
cookbook_path #{path_to('cookbooks').inspect}
...
EOM
      ...
      it "should run recipes specified as relative paths directly on the command line", :focus do
        file 'config/client.rb', <<EOM
local_mode true
client_key #{path_to('mykey.pem').inspect}
cookbook_path #{path_to('cookbooks').inspect}
...
EOM
      ...
      it "should run recipes specified directly on the command line AFTER recipes in the run list", :focus do
        file 'config/client.rb', <<EOM
local_mode true
client_key #{path_to('mykey.pem').inspect}
cookbook_path #{path_to('cookbooks').inspect}
